...
class HomeScreen extends StatelessWidget {
  ...
  Widget buildResponsiveSalutation() {
    return Responsive(
      desktop: buildSalutationText("Hi, I'm Vishal", 30),
      tablet: buildSalutationText("Hi, I'm Vishal", 30),
      mobile: buildSalutationText("Hi, I'm Vishal", 30),
    );
  }
  ...
  Widget buildResponsiveTitle() {
    return Responsive(
      desktop: buildTitleText("Flutter | Android Developer", 56),
      tablet: buildTitleText("Flutter | Android Developer", 48),
      mobile: buildTitleText("Flutter | Android Developer", 42, isPadded: true),
    );
  }
