      ...
      desktop: Column(
        ...
        children: [
          ...
          _buildAnimatedIcon(
            0,
            'email2.svg',
            () => openEmail(email: "vishalkaushal1423@gmail.com"),
            context,
          ),
     /*     const Spacer(),
          _buildAnimatedIcon(
          ...
          _buildAnimatedIcon(
            2,
            'linkedln.svg',
            () => launchUrlString("https://www.linkedin.com/in/vishal-kaushal-29620096/"),
            context,
          ),
        /*  const Spacer(),
          _buildAnimatedIcon(
      ...
      tablet: Row(
        ...
        children: [
         ...
         /* const SizedBox(width: 16),
          ...
          SocialMediaIcon(
            icon: 'linkedln.svg',
            onTap: () => launchUrlString("https://www.linkedin.com/in/vishal-kaushal-29620096/"),
            height: displayHeight(context) * 0.025,
            width: displayWidth(context) * 0.025,
          ),
         /* const SizedBox(width: 16),
